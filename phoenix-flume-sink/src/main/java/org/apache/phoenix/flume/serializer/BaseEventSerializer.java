...
public abstract class BaseEventSerializer implements EventSerializer {
    ...
    protected AtomicLong          reconnect       = new AtomicLong(0);
    ...
    public synchronized void reconnect() {
        if (reconnect.incrementAndGet() > 1000) {
            close();
    ...
    public void initialize() throws SQLException {
        ...
        try {
            ...
            Integer dt = null;
            rs =
                    connection.getMetaData().getColumns("", StringUtil.escapeLike(SchemaUtil.normalizeIdentifier(schemaName)),
    ...
    private int addToColumnMetadataInfo(final List<String> columns, final Map<String, Integer> qualifiedColumnsInfoMap, Map<String, Integer> unqualifiedColumnsInfoMap, int position)
            throws SQLException {
